...
public class ServiceTrip {
    ...
    @GetMapping
    public Iterable<travel_agency_gr3.travel_agency.entity.Trip.Trip>getTrip(){
        return tripRepo.findAll();
    }

    @PostMapping
    public void addTrip(@RequestBody travel_agency_gr3.travel_agency.entity.Trip.Trip trip){
        tripRepo.save(trip);
    }
}
